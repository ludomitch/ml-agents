...
from animalai.envs import (
    UnityEnvironment,
    UnityEnvironmentException,
    UnityActionException,
    BrainInfo,
)
from animalai.envs.mock_communicator import MockCommunicator


@mock.patch("animalai.envs.UnityEnvironment.get_communicator")
def test_handles_bad_filename(get_communicator):
    with pytest.raises(UnityEnvironmentException):
        UnityEnvironment(" ")


@mock.patch("animalai.envs.UnityEnvironment.executable_launcher")
@mock.patch("animalai.envs.UnityEnvironment.get_communicator")
