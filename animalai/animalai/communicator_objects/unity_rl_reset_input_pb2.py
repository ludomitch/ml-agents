...
from animalai.communicator_objects import (
    arena_parameters_proto_pb2 as animalai_dot_communicator__objects_dot_arena__parameters__proto__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        animalai_dot_communicator__objects_dot_arena__parameters__proto__pb2.DESCRIPTOR,
    ],
)
...
_UNITYRLRESETINPUT_ARENASENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="communicator_objects.UnityRLResetInput.ArenasEntry.key",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="communicator_objects.UnityRLResetInput.ArenasEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_UNITYRLRESETINPUT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="arenas",
            full_name="communicator_objects.UnityRLResetInput.arenas",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="seed",
            full_name="communicator_objects.UnityRLResetInput.seed",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_UNITYRLRESETINPUT_ARENASENTRY.fields_by_name[
    "value"
].message_type = (
    animalai_dot_communicator__objects_dot_arena__parameters__proto__pb2._ARENAPARAMETERSPROTO
)
_UNITYRLRESETINPUT_ARENASENTRY.containing_type = _UNITYRLRESETINPUT
_UNITYRLRESETINPUT.fields_by_name[
    "arenas"
].message_type = _UNITYRLRESETINPUT_ARENASENTRY
DESCRIPTOR.message_types_by_name["UnityRLResetInput"] = _UNITYRLRESETINPUT
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

UnityRLResetInput = _reflection.GeneratedProtocolMessageType(
    "UnityRLResetInput",
    (_message.Message,),
    {
