...
_ARENAPARAMETERSPROTO_ITEMSTOSPAWN_VECTOR3 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="communicator_objects.ArenaParametersProto.ItemsToSpawn.Vector3.x",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="communicator_objects.ArenaParametersProto.ItemsToSpawn.Vector3.y",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="z",
            full_name="communicator_objects.ArenaParametersProto.ItemsToSpawn.Vector3.z",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
...
_ARENAPARAMETERSPROTO_ITEMSTOSPAWN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="communicator_objects.ArenaParametersProto.ItemsToSpawn.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="positions",
            full_name="communicator_objects.ArenaParametersProto.ItemsToSpawn.positions",
            index=1,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rotations",
            full_name="communicator_objects.ArenaParametersProto.ItemsToSpawn.rotations",
            index=2,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="sizes",
            full_name="communicator_objects.ArenaParametersProto.ItemsToSpawn.sizes",
            index=3,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="colors",
            full_name="communicator_objects.ArenaParametersProto.ItemsToSpawn.colors",
            index=4,
            number=6,
            type=11,
            cpp_type=10,
...
_ARENAPARAMETERSPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="t",
            full_name="communicator_objects.ArenaParametersProto.t",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="items",
            full_name="communicator_objects.ArenaParametersProto.items",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="blackouts",
            full_name="communicator_objects.ArenaParametersProto.blackouts",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_ARENAPARAMETERSPROTO_ITEMSTOSPAWN_VECTOR3.containing_type = (
    _ARENAPARAMETERSPROTO_ITEMSTOSPAWN
)
_ARENAPARAMETERSPROTO_ITEMSTOSPAWN.fields_by_name[
    "positions"
].message_type = _ARENAPARAMETERSPROTO_ITEMSTOSPAWN_VECTOR3
_ARENAPARAMETERSPROTO_ITEMSTOSPAWN.fields_by_name[
    "sizes"
].message_type = _ARENAPARAMETERSPROTO_ITEMSTOSPAWN_VECTOR3
_ARENAPARAMETERSPROTO_ITEMSTOSPAWN.fields_by_name[
...
_ARENAPARAMETERSPROTO.fields_by_name[
    "items"
].message_type = _ARENAPARAMETERSPROTO_ITEMSTOSPAWN
DESCRIPTOR.message_types_by_name["ArenaParametersProto"] = _ARENAPARAMETERSPROTO
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ArenaParametersProto = _reflection.GeneratedProtocolMessageType(
    "ArenaParametersProto",
    (_message.Message,),
    {
        "ItemsToSpawn": _reflection.GeneratedProtocolMessageType(
            "ItemsToSpawn",
            (_message.Message,),
            {
