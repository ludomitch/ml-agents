...
from animalai.communicator_objects import (
    unity_output_pb2 as animalai_dot_communicator__objects_dot_unity__output__pb2,
)
from animalai.communicator_objects import (
    unity_input_pb2 as animalai_dot_communicator__objects_dot_unity__input__pb2,
)
from animalai.communicator_objects import (
    header_pb2 as animalai_dot_communicator__objects_dot_header__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        animalai_dot_communicator__objects_dot_unity__output__pb2.DESCRIPTOR,
        animalai_dot_communicator__objects_dot_unity__input__pb2.DESCRIPTOR,
        animalai_dot_communicator__objects_dot_header__pb2.DESCRIPTOR,
    ],
)
...
_UNITYMESSAGE.fields_by_name[
    "header"
].message_type = animalai_dot_communicator__objects_dot_header__pb2._HEADER
_UNITYMESSAGE.fields_by_name[
    "unity_output"
].message_type = animalai_dot_communicator__objects_dot_unity__output__pb2._UNITYOUTPUT
_UNITYMESSAGE.fields_by_name[
    "unity_input"
].message_type = animalai_dot_communicator__objects_dot_unity__input__pb2._UNITYINPUT
