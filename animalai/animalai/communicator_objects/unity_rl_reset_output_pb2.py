...
_UNITYRLRESETOUTPUT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="arenas_instanciated",
            full_name="communicator_objects.UnityRLResetOutput.arenas_instanciated",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
UnityRLResetOutput = _reflection.GeneratedProtocolMessageType(
    "UnityRLResetOutput",
    (_message.Message,),
    {
