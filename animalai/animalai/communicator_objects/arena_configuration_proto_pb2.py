...
from animalai.communicator_objects import items_to_spawn_proto_pb2 as animalai_dot_communicator__objects_dot_items__to__spawn__proto__pb2
...
_ARENACONFIGURATIONPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='t', full_name='communicator_objects.ArenaConfigurationProto.t', index=0,
...
ArenaConfigurationProto = _reflection.GeneratedProtocolMessageType('ArenaConfigurationProto', (_message.Message,), dict(
