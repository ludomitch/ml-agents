...
DemonstrationMetaProto = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "animalai.communicator_objects.demonstration_meta_proto_pb2"
