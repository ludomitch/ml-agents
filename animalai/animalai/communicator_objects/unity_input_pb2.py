...
from animalai.communicator_objects import (
    unity_rl_input_pb2 as animalai_dot_communicator__objects_dot_unity__rl__input__pb2,
)
from animalai.communicator_objects import (
    unity_rl_initialization_input_pb2 as animalai_dot_communicator__objects_dot_unity__rl__initialization__input__pb2,
)
from animalai.communicator_objects import (
    unity_rl_reset_input_pb2 as animalai_dot_communicator__objects_dot_unity__rl__reset__input__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        animalai_dot_communicator__objects_dot_unity__rl__input__pb2.DESCRIPTOR,
        animalai_dot_communicator__objects_dot_unity__rl__initialization__input__pb2.DESCRIPTOR,
        animalai_dot_communicator__objects_dot_unity__rl__reset__input__pb2.DESCRIPTOR,
    ],
)
...
_UNITYINPUT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="rl_reset_input",
            full_name="communicator_objects.UnityInput.rl_reset_input",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_UNITYINPUT.fields_by_name[
    ...
    animalai_dot_communicator__objects_dot_unity__rl__input__pb2._UNITYRLINPUT
)
_UNITYINPUT.fields_by_name[
    "rl_initialization_input"
].message_type = (
    animalai_dot_communicator__objects_dot_unity__rl__initialization__input__pb2._UNITYRLINITIALIZATIONINPUT
)
_UNITYINPUT.fields_by_name[
    "rl_reset_input"
].message_type = (
    animalai_dot_communicator__objects_dot_unity__rl__reset__input__pb2._UNITYRLRESETINPUT
)
