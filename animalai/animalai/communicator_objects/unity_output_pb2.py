...
from animalai.communicator_objects import (
    unity_rl_output_pb2 as animalai_dot_communicator__objects_dot_unity__rl__output__pb2,
)
from animalai.communicator_objects import (
    unity_rl_initialization_output_pb2 as animalai_dot_communicator__objects_dot_unity__rl__initialization__output__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        animalai_dot_communicator__objects_dot_unity__rl__output__pb2.DESCRIPTOR,
        animalai_dot_communicator__objects_dot_unity__rl__initialization__output__pb2.DESCRIPTOR,
    ],
)
...
_UNITYOUTPUT.fields_by_name[
    ...
    animalai_dot_communicator__objects_dot_unity__rl__output__pb2._UNITYRLOUTPUT
)
_UNITYOUTPUT.fields_by_name[
    "rl_initialization_output"
].message_type = (
    animalai_dot_communicator__objects_dot_unity__rl__initialization__output__pb2._UNITYRLINITIALIZATIONOUTPUT
)
